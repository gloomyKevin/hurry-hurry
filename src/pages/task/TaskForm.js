        ...
        <Form onSubmit={handleSubmit}>
            ...
            <FormItem>
                {getFieldDecorator('level', {
                    ...
                    <Radio.Group>
                        <Radio style={radioStyle} value={1}>{radioText[0]}</Radio>
                        <Radio style={radioStyle} value={2}>{radioText[1]}</Radio>
                        <Radio style={radioStyle} value={3}>{radioText[2]}</Radio>
                        <Radio style={radioStyle} value={4}>{radioText[3]}</Radio>
                    </Radio.Group>,
                )}
            </FormItem>
            <FormItem label={'时间'}>
